      ...
      <div className="relative w-full max-w-[420px] h-full bg-white flex flex-col shadow-2xl z-10 animate-slide-in-left">
        ...
        <div className="border-t border-slate-100 p-6 bg-slate-50 shrink-0">
          ...
          <div className="grid grid-cols-2 gap-3">
            {/* Return to Store Button (Grey) */}
            <button
              onClick={() => {
                setIsOpen(false);
                router.push("/store");
              }}
              className="w-full hover:bg-slate-300 text-slate-800 py-3 rounded-xl font-black text-xs transition-all cursor-pointer text-center border-0"
              style={{ backgroundColor: "#c5cbda" }}
            >
              الرجوع للمتجر
            </button>
