...
export const metadata: Metadata = {
  ...
  description:
    "الجارحي لقطع غيار السيارات - التشكيلة الأضخم من قطع غيار محركات الهايبرد والكهرباء والميكانيك في الأردن بجودة مضمونة وكفالة حقيقية وتوصيل للمحافظات.",
  keywords: [
  ...
  verification: {
    google: "Py-AklT4Lg6NlN_5ofPESap8lSGjdGV_pJ-gX9_vxBQ",
  },
  alternates: {
    canonical: SITE_URL,
    languages: {
