...
export const metadata: Metadata = {
  ...
  description:
    "اتصل بمركز الجارحي لقطع غيار السيارات في الأردن. أرقام هواتف فروع البيادر والقويسمة وقسم مبيعات الجملة. أرسل استفسارك ورقم الشاصي لمطابقة القطعة فوراً.",
  keywords: [
  ...
  openGraph: {
    ...
    description:
      "تواصل مع فروعنا في البيادر والقويسمة، أو أرسل رقم الشاصي لطلب القطعة ومطابقتها مباشرة عبر واتساب.",
