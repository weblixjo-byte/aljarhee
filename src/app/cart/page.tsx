                  ...
                  <div className={`p-3 rounded-xl border text-xs font-bold flex items-center justify-between gap-2 transition-all ${
                    ...
                    {subtotal >= 20 ? (
                      <span className="font-black">
                        قيمة الطلب 20 د.أ أو أكثر - تم تطبيق التوصيل المجاني لكافة المحافظات.
                      </span>
                    ) : (
                      <span>
                        أضف بضائع بقيمة <strong className="font-en font-black text-amber-900">{(20 - subtotal).toFixed(1)} د.أ</strong> إضافية للحصول على توصيل مجاني.
                      </span>
                    )}
                  </div>
                )}
                  ...
                  >
                    {JO_CITIES.map((city) => (
                      <option key={city.key} value={city.key}>
                        {city.name} {subtotal >= 20 ? "(توصيل مجاني)" : `(توصيل ${city.fee} د.أ - مجاني للطلبات 20 د.أ أو أكثر)`}
                      </option>
                    ))}
                  </select>
                </div>
