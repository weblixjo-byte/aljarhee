...
/**
 * Enforces strict maximum 60 characters limit for SEO titles across the site.
 */
...
/**
 * Enforces strict maximum 150 characters limit for SEO descriptions across the site.
 */
export function formatSeoDescription(desc: string): string {
